...
void DSD0_2_IRQHandler(void)
{
	;
}

void DSD0_3_IRQHandler(void)
{
	;
}

void DSD0_4_IRQHandler(void)
{
	;
}

void DSD0_5_IRQHandler(void)
{
	;
}

void DSD0_6_IRQHandler(void)
{
	;
}

void DSD0_7_IRQHandler(void)
{
	;
}
