...
REM Standard paths
SET FREERTOS_SOURCE=H:\FreeRTOSv10.1.1\FreeRTOS\Source
SET COMMON_SOURCE=H:\FreeRTOSv10.1.1\FreeRTOS\Demo\Common\minimal
SET COMMON_INCLUDE=H:\FreeRTOSv10.1.1\FreeRTOS\Demo\Common\include
